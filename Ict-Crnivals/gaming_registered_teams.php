...
<?php
 ...
 require_once("includes/datbs.php");
	 ...
	 function view_gaming_contestant(){
 	include("includes/datbs.php");
 		$leader_email = $_SESSION['leader_email'] ?? '';
		$fetch_contestant=$con->prepare("select * from gaming  ");
		...
		echo"<tr> 
				...
				<img src='imgs/gaming_contestant_img/".$row['team_picture']."' 
				/>  </td>
				

				<td style='min-wdith:350px;'>
				<img src='imgs/gaming_uni_com_id_img/".$row['university_combined_id_picture']."' /> </td>
