...
<?php
 ...
 require_once("includes/datbs.php");
	 ...
	 function view_programming_contestant(){
 	include("includes/datbs.php");
 		$leader_email = $_SESSION['leader_email'] ?? '';
		$fetch_contestant=$con->prepare("select * from tbl_team_registration  ");
		...
		echo"<tr> 
				...
				<img src='imgs/contestant_img/".$row['team_picture']."' 
				/>  </td>
				

				<td style='min-wdith:350px;'>
				<img src='imgs/uni_com_id_img/".$row['university_combined_id_picture']."' /> </td>
	...
	<form method="POST" enctype="multipart/form-data">
		...
		<table  >
			...
			<?php 
				 ...
				 echo view_programming_contestant();
			 ?>
