...
<?php
 ...
 require_once("includes/datbs.php");
	 ...
	 function view_project_show_contestant(){
 	include("includes/datbs.php");
 		$leader_email = $_SESSION['leader_email'] ?? '';
		$fetch_contestant=$con->prepare("select * from project_show  ");
		...
		echo"<tr> 
				...
				<img src='imgs/project_contestant_img/".$row['team_picture']."' 
				/>  </td>
				

				<td style='min-wdith:350px;'>
				<img src='imgs/project_uni_com_id_img/".$row['university_combined_id_picture']."' /> </td>
	...
	<form method="POST" enctype="multipart/form-data">
		...
		<table  >
			...
			<?php 
				 ...
				 echo view_project_show_contestant();
			 ?>
